...
<table class="am-table am-table-bordered am-table-compact am-text-truncate">
    ...
    for($i=0; $i<6;$i++)
    {
        if(@$curriculum_weeks['data'][$i][0])
        {
            ...
            echo "<td>".$curriculum_weeks['data'][$i][0][1]."</td>";
...
<table class="am-table am-table-bordered am-table-compact am-text-truncate">
    ...
    for($i=0; $i<6;$i++)
    {
        if(@$curriculum_weeks['data'][$i][1])
        {
            ...
            echo "<td>".$curriculum_weeks['data'][$i][1][1]."</td>";
...
<table class="am-table am-table-bordered am-table-compact am-text-truncate">
    ...
    for($i=0; $i<6;$i++)
    {
        if(@$curriculum_weeks['data'][$i][2])
        {
            ...
            echo "<td>".$curriculum_weeks['data'][$i][2][1]."</td>";
...
<table class="am-table am-table-bordered am-table-compact am-text-truncate">
    ...
    for($i=0; $i<6;$i++)
    {
        if(@$curriculum_weeks['data'][$i][3])
        {
            ...
            echo "<td>".$curriculum_weeks['data'][$i][3][1]."</td>";
...
<table class="am-table am-table-bordered am-table-compact am-text-truncate">
    ...
    for($i=0; $i<6;$i++)
    {
        if(@$curriculum_weeks['data'][$i][4])
        {
            ...
            echo "<td>".$curriculum_weeks['data'][$i][4][1]."</td>";
...
<table class="am-table am-table-bordered am-table-compact am-text-truncate">
    ...
    for($i=0; $i<6;$i++)
    {
        if(@$curriculum_weeks['data'][$i][5])
        {
            ...
            echo "<td>".$curriculum_weeks['data'][$i][5][1]."</td>";
...
<table class="am-table am-table-bordered am-table-compact am-text-truncate">
    ...
    for($i=0; $i<6;$i++)
    {
        if(@$curriculum_weeks['data'][$i][6])
        {
            ...
            echo "<td>".$curriculum_weeks['data'][$i][6][1]."</td>";
